    ...
    <section className="bg-[#f8fafc] py-16">
      <Container className="">
        ...
        <div className="flex items-center justify-center mb-12">
          <form onSubmit={handleClick} className="flex w-full max-w-xl bg-white rounded-full shadow-md overflow-hidden">
            <input
              type="text"
              name="text"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-12">
          {district?.map((district, index) => (
            <div
              ...
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-lg transition flex items-center gap-3 cursor-pointer"
            >
        ...
        <div className="w-full h-120 rounded-2xl overflow-hidden">
            <MapContainer ref={mapRef} center={position} zoom={7} scrollWheelZoom={false} className="w-full h-full">
              <TileLayer
